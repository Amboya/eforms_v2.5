...
class CreateConfigDivisionUserUnit extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('config_division_user_unit', function (Blueprint $table) {
            $table->id();
            $table->string('name');
    ...
    {
        Schema::dropIfExists('config_division_user_unit');
    }
}
