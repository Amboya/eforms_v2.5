...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Directorates Kilometer-Allowance Totals</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    ...
                    <div class="card card-success">
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                <a href="{{route('kilometer.allowance.reports.sync.directorates')}}" class="btn btn-tool">
                                    <i class="fas fa-sync"> Directorates</i>
                                </a>
                                <a href="{{route('kilometer.allowance.reports.sync.units')}}" class="btn btn-tool">
