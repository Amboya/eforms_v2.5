@extends('layouts.eforms.users-records-request.master')
...
@section('content')
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{route('user-records-request-home')}}">Home</a></li>
    ...
    <!-- Default box -->
        <div class="card">
            <form enctype="multipart/form-data" name="db1" action="{{route('user-records-request-store')}}"
                  method="post">
                @csrf
                <div class="card-body">
                    ...
                    <table border="1" width="100%" cellspacing="0" cellpadding="0" align="Centre"
                        ...
                        <tr>
                            <th width="33%" class="text-center"><a href="#"><img
                                        ...
                                        width="30%"></a></th>
                            <th width="33%" colspan="4" class="text-center">Kilometer Allowance Voucher</th>
                    ...
                    <div class="row mt-2 mb-4">
                        ...
                        <div class="col-4 mb-1">
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <input value="{{Auth::user()->location->name }}" type="text" name="station" readonly
                                           class="form-control">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-12 grid-margin stretch-card">
                        ...
                        <div class="form-group">
                            <label for="vehicle_reg_no" class="col-sm-2 control-label">Motor Vehicle Registration
                                No</label>
                            <div class="col-sm-12">
                                        ...
                                        <div class="form-group">
                                            <div class="radio">
                                                <label>
                                                    <input type="radio" name="engine_capacity" id="engine_capacity1"
                                                           value="Motor Cycle (15% of cost of fuel)" checked>
                                            ...
                                            <div class="radio">
                                                <label>
                                                    ...
                                                    Motor Car over 2000cc (40% of cost of fuel)
                                                </label>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-4">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                        <input type="number" step='0.01' required class="form-control" name="pump_price"
                                               id="pump_price" placeholder="Enter the Pump Price">
                                    </div>
                                </div>
                            </div>
                            <div class="col-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                        <input type="number" required class="form-control" name="claim_amount"
                                               id="claim_amount" placeholder="Enter the Amount of Claim">
                                    </div>
                                </div>
                            </div>
                        </div>
