...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Vehicle-Requisitioning Accounts List</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
    ...
    <!-- Default box -->
        <div class="card">
            ...
            <div class="card-header text-right  ">
                <a class="btn btn-sm btn-success " href="{{route('vehicle.requisitioning.report.export')}}">
            ...
            <div class="card-footer clearfix">
                {{--@if( Auth::user()->profile_id ==  config('constants.user_profiles.EZESCO_002'))--}}
                    ...
                    {{--@else--}}
                        ...
                        {{--<span class="text-danger m-3"> Sorry, You can not raise a new Vehicle Requisition claim because you already have an open Vehicle Requisition claim.</span>--}}
                    {{--@endif--}}
                {{--@endif--}}
            </div>
        </div>
