...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Directorates Vehicle Requisition Totals</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{route('main-home')}}">Home</a></li>
                        <li class="breadcrumb-item active">Directorates Vehicle Requisition Totals</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                    ...
                    <div class="card card-success">
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                <a href="{{route('vehicle.requisitioning.reports.sync.directorates')}}" class="btn btn-tool">
                                    <i class="fas fa-sync"> Directorates</i>
                                </a>
                                <a href="{{route('vehicle.requisitioning.reports.sync.units')}}" class="btn btn-tool">
