    ...
    <script>
        $("#search_button").click(function () {
            ...
            if(unit_selected_value == "" || status_selected_value == "" || start_date == "" || end_date == ""  ){
                ...
                //get the route
                var route = '{{url('vehicle/requisitioning/filtered/report/get')}}' + '/' + unit_selected_value  + '/' + status_selected_value+ '/' + start_date+ '/' + end_date;
                // alert(route);
                $.ajax({
                    url: route,
                    type: 'get',
                         ...
                         if(response_data.superior){
                             ...
                             for(var i = 0; i < list.length; i++){
                                 ...
                                 $.each( list[i], function (index, value) {
                                     ...
                                     //list array
                                     var route = '{{ url('vehicle/requisitioning/showForm') }}' + '/'+ value.id ;
                                     var View = "View";
                                     //populate the table
                                     list_responce +=
                                         "<tr> " +
            ...
            {{--//get the route--}}
            {{--var route = '{{url('vehicle/requisitioning/filtered/report/get')}}' + '/' + selected_value  + '/' + selected_value+ '/' + selected_value+ '/' + selected_value;--}}
