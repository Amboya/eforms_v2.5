...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Kilometer Allowance Claim Detail [ {{ $form->code }} ]</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
    ...
    <!-- Default box -->
        <div class="card">
            <form name="db1" action="{{route('kilometer-allowance-approve')}}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
