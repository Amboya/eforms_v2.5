@extends('layouts.eforms.gifts-benefits-register.master')
...
@section('content')
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{route('gifts-benefits-home')}}">Home</a></li>
    ...
    <!-- Default box -->
        <div class="card">
            <form enctype="multipart/form-data" name="db1" action="{{route('gifts-benefits-store')}}"
                  method="post">
                @csrf
                <div class="card-body">
