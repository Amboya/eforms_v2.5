                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="row mt-2 mb-4" >
                            ...
                            <div  class="col-12"><input  value="{{ date('Y-m-d H:i:s') }}"  type="text" name="date" readonly class="form-control"></div>
                            </div>
                        </div>
                             <div class="col-3">
                                 <div class="row">
                            ...
                            <div  class="col-12"> <input type="text" name="cost_center" class="form-control"
                                           value="{{ $user->user_unit->cost_center_code}}" readonly required>
                            </div>
                        </div>
                        </div>
                         <div class="col-3">
                            ...
                            <div  class="col-12"><input type="text" name="ref_no" placeholder="Enter Your HQMS Number" required class="form-control"></div>
                        </div>
                        </div>
                         <div class="col-3">
                            <div class="row">
                            <div  class="col-12"><label>Project Number:</label></div>
                            <div  class="col-12"><input list="project_list" type="text" name="projects_id" class="form-control"
...
{{--                                        <input type="text" name="name[]" class="form-control amount" placeholder="Item Details" id="name" required >--}}
                                        <textarea rows="4" type="text" name="name[]" class="form-control amount" placeholder="Item Details / Description" id="name" required ></textarea>
                                    </TD>
                                    <TD> <input type="number" id="amount" name="amount[]" onchange="getvalues()" class="form-control amount" placeholder="Amount [ZMW]" >
                                    </TD>
                                </TR>
                            </TABLE>
                        </div>
                ...
                <div class="row mb-1 mt-4">
                    ...
                    <div class="row mb-1">
                            ...
                            <div  class="col-3"><input type="text" name="claim_authorised_by" readonly class="form-control"></div>
                            <div  class="col-2 text-center"><label>Signature:</label></div>
                            <div  class="col-2"><input type="text" name="sig_of_authorised" readonly class="form-control"></div>
                            <div  class="col-1  text-center"><label>Date:</label></div>
                            <div  class="col-2"><input type="text" name="authorised_date" readonly class="form-control"></div>
                    </div>
                    <div class="row mb-1">
                            <div  class="col-2"><label>HR/Station Manager:</label></div>
                            <div  class="col-3"><input type="text" name="station_manager" readonly class="form-control"></div>
                            <div  class="col-2 text-center"><label>Signature:</label></div>
                            <div  class="col-2"><input type="text" name="sig_of_station_manager" readonly class="form-control"></div>
                            <div  class="col-1 text-center"><label>Date:</label></div>
                    ...
                    <div class="row mb-4" >
                            ...
                            <div  class="col-2 text-center"><label>Signature:</label></div>
                            <div  class="col-2"><input type="text" name="sig_of_accountant" readonly class="form-control"></div>
                            <div  class="col-1 text-center"><label>Date:</label></div>
                            <div  class="col-2"><input type="text" name="accountant_date" readonly class="form-control"></div>
                    </div>
