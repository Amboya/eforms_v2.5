                    ...
                    <div class="card">
                        ...
                        <div class="card-footer clearfix">
                            @if( Auth::user()->profile_id ==  config('constants.user_profiles.EZESCO_002'))
                                @if($pending < 1)
                                    <a href="{{route('virement-create')}}"
                                       class="btn btn-sm bg-gradient-green float-left">New Virement Form</a>
                                @else
                                    <a href="#" class="btn btn-sm btn-default float-left">New Virement</a>
