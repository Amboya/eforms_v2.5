@extends('layouts.eforms.temps-casuals.master')
...
@section('content')
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{route('temps-casuals-home')}}">Home</a></li>
    ...
    <!-- Default box -->
        <div class="card">
            <form enctype="multipart/form-data" name="db1" action="{{route('temps-casuals-store')}}"
                  method="post">
                @csrf
                <div class="card-body">
