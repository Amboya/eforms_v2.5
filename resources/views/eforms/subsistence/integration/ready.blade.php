                                    ...
                                    <td>
                                        <a href="{{ route('logout') }}"
                                           onclick="event.preventDefault();
                                               document.getElementById('show-form'+{{$item->eform_subsistence_id ?? 0 }}).submit();"> {{$item->form->code ?? 0 }}</a>
                                        <form id="show-form{{$item->invoice_id}}"
                                              action="{{ route('subsistence.show', $item->eform_subsistence_id ?? 0) }}"
                                    ...
                                    <td>
                                        <a href="{{ route('logout') }}" class="btn btn-sm bg-orange"
                                           onclick="event.preventDefault();
                                            ...
                                            View </a>
                                        <form id="show-form{{$item->eform_subsistence_id}}"
                                              action="{{ route('subsistence.show', $item->eform_subsistence_id) }}"
                                              method="POST" class="d-none">
                                            @csrf
                                        </form>
                                    </td>
