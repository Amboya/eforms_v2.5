...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark text-orange text-uppercase">SUBSISTENCE BY UNITS : <span class="text-green">{{$category}}</span></h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
    ...
    <!-- Default box -->
        <div class="card">
            ...
            <div class="card-header">
                <!-- SEARCH FORM -->
                <form class="form-inline ml-3" method="post" action="{{route('subsistence.invoices.units.search')}}">
                    @csrf
