    ...
    <div class="modal fade" id="modal-edit">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <!-- form start -->
                <form role="form" method="post" action="{{route('subsistence.workflow.update', ['code'=> config('constants.all')] )}}">
                    @csrf
                            ...
                            <div class="col-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="bm_code" name="bm_code"
                                           placeholder="Enter Snr Managers">
                                </div>
                            </div>
                            <div class="col-3">
                                <div class="form-group">
...
@push('custom-scripts')
    ...
    <script>
        ...
        $('#modal-view').on('show.bs.modal', function (event) {
            ...
            var bm_code = document.getElementById("bm_code");
            bm_code.textContent = recipient.bm_code;
            var bm_unit = document.getElementById("bm_unit");
            bm_unit.textContent = recipient.bm_unit;
