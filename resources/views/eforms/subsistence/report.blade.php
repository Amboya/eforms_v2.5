...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Subsistence Accounts List</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{route('main-home')}}">Home</a></li>
                        <li class="breadcrumb-item active">Subsistence Accounts List</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
        ...
        <div class="card">
            ...
            <div class="card-header text-right  ">
                ...
                @if (Auth::user()->type_id == config('constants.user_types.developer') )
                    <a class="btn btn-sm btn-default " href="#" title="Only Chief Account and Expenditure Officers can Export">
                        Export {{sizeof($list)}} Records <i class="fa fa-download"></i>
                    </a>
                @endif
            </div>
