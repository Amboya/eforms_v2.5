...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Divisional User Unit</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title text-center">Create New Divisional User Unit</h4>
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Divisional User Unit Name</label>
                                    <input type="text" class="form-control" id="name" name="name"
                                           placeholder="Enter Divisional user unit name" required>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="code">Divisional User Unit Code</label>
                                    <input type="text" class="form-control" id="code" name="code"
                                           placeholder="Enter Divisional user unit code">
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
...
{{--                                <b>Period:</b> <span id="span_period"></span><br>--}}
    ...
    <div class="modal fade" id="modal-edit">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title text-center">Update Divisional User Unit</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="divisional-user-unit_name2" name="name"
                                           placeholder="Enter Divisional user unit name" required>
                                </div>
                                <input hidden type="text" class="form-control" id="divisional-user-unit_id2" name="divisional-user-unit_id"
                                       required>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Divisional User Unit Code</label>
                                    <input type="text" class="form-control" id="divisional-user-unit_code2" name="code"
                                           placeholder="Enter Divisional user unit Code" required>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
        ...
        <div class="modal fade" id="modal-delete{{$item->id}}">
            <div class="modal-dialog modal-sm">
                <div class="modal-content bg-defualt">
                    <div class="modal-header">
                        <h4 class="modal-title text-center">Delete Divisional User Unit</h4>
                    </div>
                    <!-- form start -->
...
<script>
    ...
    $('#modal-edit').on('show.bs.modal', function (event) {
        ...
        $('#divisional_user_unit_name2').val(recipient.name);
        $('#divisional_user_unit_id2').val(recipient.id);
        $('#divisional_user_unit_code2').val(recipient.code);
