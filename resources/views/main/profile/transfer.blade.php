...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Profile Transfer</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{route('main.home')}}">Home</a></li>
                        <li class="breadcrumb-item active">Profile Transfer</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    ...
    <!-- Default box -->
        <div class="card">
            ...
            <div class="card-body">
                <!-- form start -->
                <form role="form-new" method="post" action="{{route('main.profile.transfer.create')}}">
                    @csrf
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    <label>Select New Profile Owner</label>
                ...
                $.each(profile, function (index, value1) {
                    if (value1.user_id == selected_value1) {
                        ...
                        responce2 += "<tr><td> " +
                            ...
                            "<input type='checkbox' value='{"+'"profiles"'+":" + pro +" ,"+'"form"'+":" + value1.form.id +"}'  id='transfer_profiles[]'" +
                            "name='transfer_profiles[]'> " +
