...
<head>
    ...
    <title>Vehicle Requisitioning | Dashboard 2</title>
...
<div class="wrapper">
    ...
    <!-- Navbar -->
@include('layouts.eforms.vehicle-requisitioning.navbar')
    <!-- /.navbar -->

    <!-- Main Sidebar Container -->
@include('layouts.eforms.vehicle-requisitioning.sidebar')
    ...
    <!-- Main Footer -->
    @include('layouts.eforms.vehicle-requisitioning.footer')
