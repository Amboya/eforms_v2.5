    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column " data-widget="treeview" role="menu"
                ...
                <li class="nav-item">
                    <a href="{{route('hotel.accommodation.home')}}" class="nav-link ">
                        <i class="nav-icon fas fa-tachometer-alt"></i>
                        <p>Dashboard</p>
                    </a>
                </li>

                <li class="nav-header">HOTEL ACCOMMODATION</li>
                <li class="nav-item">
                    <a href="{{route('hotel.accommodation.list', 'needs_me')}}" class="nav-link ">
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{route('hotel.accommodation.list', 'all')}}" class="nav-link ">
                        ...
                        <li class="nav-item">
                            <a href="{{route('hotel.accommodation.list', 'pending')}}" class="nav-link ">
                                <i class="far fa-circle nav-icon"></i>
                                <p> Open
                                </p>
                            </a>
                ...
                Auth::user()->profile_id == config('constants.user_profiles.EZESCO_014'))
                    <li class="nav-item">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                {{--                        <a href="{{route('hotel.accommodation.report', config('constants.all'))}}" class="nav-link ">--}}
                                {{--                            <i class="nav-icon fas fa-file"></i>--}}
                                {{--                            <p> All Reports--}}
                                {{--                            </p>--}}
                                {{--                        </a>--}}
                            ...
                            <li class="nav-item">
                                <a href="{{route('hotel.accommodation.report', config('constants.petty_cash_status.exported'))}}"
                                   class="nav-link ">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p> Exported
                                    </p>
                            ...
                            <li class="nav-item">
                                <a href="{{route('hotel.accommodation.report', config('constants.petty_cash_status.not_exported'))}}"
                                   class="nav-link ">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p> Not Exported
                                    </p>
                            ...
                            <li class="nav-item">
                                <a href="{{route('hotel.accommodation.report', config('constants.petty_cash_status.export_failed'))}}"
                                   class="nav-link ">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p> Export Failed
                                    </p>
                ...
                {{--                                            </li>--}}
                {{--                                            <li class="nav-item">--}}
                {{--                                                <a href="{{route('hotel.accommodation.reports-index')}}" class="nav-link ">--}}
                {{--                                                    <i class="nav-icon fas fa-file"></i>--}}
                {{--                                                    <p> All Time--}}
                {{--                                                    </p>--}}
                {{--                                                </a>--}}
