...
<head>
    ...
    <title>Draft Gifts and benefits Register-2019 | Dashboard 2</title>
...
<div class="wrapper">
    <!-- Navbar -->
@include('layouts.eforms.gifts-benefits-register.navbar')
    <!-- /.navbar -->

    <!-- Main Sidebar Container -->
@include('layouts.eforms.gifts-benefits-register.sidebar')
    ...
    <!-- Main Footer -->
    @include('layouts.eforms.gifts-benefits-register.footer')
