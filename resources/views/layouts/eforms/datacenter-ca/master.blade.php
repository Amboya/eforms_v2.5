...
<head>
    ...
    <title>eZesco | Data Center CA Form</title>
...
<div class="wrapper">
    ...
    <!-- Navbar -->
@include('layouts.eforms.datacenter-ca.navbar')
    <!-- /.navbar -->

    <!-- Main Sidebar Container -->
@include('layouts.eforms.datacenter-ca.sidebar')
    ...
    <!-- Main Footer -->
    @include('layouts.eforms.datacenter-ca.footer')
