...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">System Profile</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title text-center">Create New System Profile</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <!-- form start -->
                <form role="form-new" method="post" action="{{route('main-profile-store')}}">
                    @csrf
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="code">Profile Code</label>
    ...
    <div class="modal fade" id="modal-edit">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <!-- form start -->
                <form role="form" method="post" action="{{route('main-profile-update')}}">
                    @csrf
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="profile_name2" name="name"
                                           placeholder="Enter profile name" required>
                                </div>
                                <input hidden type="text" class="form-control" id="profile_id2" name="profile_id"
                                       required>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
        ...
        <div class="modal fade" id="modal-delete{{$item->id}}">
            <div class="modal-dialog modal-sm">
                <div class="modal-content bg-defualt">
                    <div class="modal-header">
                        <h4 class="modal-title text-center">Delete System Profile</h4>
                    </div>
                    <!-- form start -->
                    <form role="form" method="post"
                          action="{{route('main-profile-destroy', ['id' => $item->id])}}">
                        @csrf
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-12">
