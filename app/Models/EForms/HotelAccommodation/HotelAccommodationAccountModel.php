...
class HotelAccommodationAccountModel extends Model
{
    use HasFactory;
    use SoftDeletes;

    //table name
    protected $table = 'eform_hotel_accommodation_account';
    //primary key
    ...
    protected $fillable = [
        ...
        'debitted_account_id',
        'debitted_amount',
        'eform_hotel_accommodation_id',

        'hotel_accommodation_code',
